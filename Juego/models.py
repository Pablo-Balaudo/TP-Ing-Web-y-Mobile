...
class Pixel(models.Model):
    ...
    coordenadaX = models.PositiveIntegerField(default=0, validators=[MaxValueValidator(TamañoLienzo)])
    coordenadaY = models.PositiveIntegerField(default=0, validators=[MaxValueValidator(TamañoLienzo)])
...
def CrearPixeles(sender, instance, created, **kwargs):
    if created:
...
@receiver(post_save, sender=Lienzo)
def GuardarPixeles(sender, instance, **kwargs):
    instance.pixel.save()    
