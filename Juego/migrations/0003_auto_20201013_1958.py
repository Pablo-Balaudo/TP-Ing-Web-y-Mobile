...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('denuncia_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='Usuarios.denuncia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Header', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Juego.denunciajugadasheader')),
